...
export default function Home() {
    ...
    const [gamesPerPage, ] = useState(15) // mis personajes por pagina, que son 15
    const indexOfLastGame = currentPage * gamesPerPage // va a ser 15, indice del ultimo juego por pagina
    const indexOfFirstGame = indexOfLastGame - gamesPerPage //
    const [setOrden] = useState('')  // estado local para el handleFilterByName
    ...
    return (
        < div >
            ...
            <h1 className="welcome">NETFLIGAMES</h1>
            <SearchBar />
            <br />
